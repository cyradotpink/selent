...
$execute store success score @s kira_util_select_entity_scratch_0 run data modify storage kira_util:select_entity scratch.entity_data set from entity @n[type=!item,distance=..20,$(selector_args)]
