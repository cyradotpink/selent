...
$data modify storage kira_util:iter select_entity.in set from storage kira_util:select_entity players."$(UUID)".selected_uuids
...
$data modify storage kira_util:select_entity scratch.stage_args set value {player_uuid: $(UUID)}
