...
title @s reset
title @s actionbar [{text: "", color: "#f7518e"}, {text: "[selent] Set ", color: "#fffb21"}, {nbt: "out", storage: "kira_util:select_entity", interpret: true}, {text: "'s scale to ", color: "#fffb21"}, {nbt: "args.value_percent", storage: "selent:scratch"}, "%"]
